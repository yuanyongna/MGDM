...
from utils.reconstruct_adapter import make_mol_openbabel
...
if __name__ == '__main__':
    ...
    # # for 1k sample
    # config.dataset.split='/raw/data/split_by_name.pt'
    ...
    if config.dataset.name == 'crossdock':
        if 'pocket' or'sa' in args.ckpt:
            ...
            dataset_info = get_dataset_info('crossdock', False)
        protein_root = '/raw/data/crossdocked_pocket10'
    else:
